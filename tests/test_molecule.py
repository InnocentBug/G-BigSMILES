...
def test_molecule():
    test_args = [
        ...
        (
            ...
            "[H]CC(C)(CC(C)(C(=O)OCC(O)CSc1c(F)c(F)c(F)c(F)c1F)C(C)C(Cc1ccccc1)C(Cc1ccccc1)C(Cc1ccccc1)C(Cc1ccccc1)C(Cc1ccccc1)C(Cc1ccccc1)C(C)CC(c1ccccc1)c1ccccc1)C(=O)OCC(O)CSc1c(F)c(F)c(F)c(F)c1F",
        ),
        (
