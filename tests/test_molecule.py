...
def test_molecule():
    test_args = [
        ...
        (
            "[H]{[>]CC([>])(C[<])C(=O)OCC(O)CSc1c(F)c(F)c(F)c(F)c1F[<]}|schulz_zimm(500, 10)|[<]CC.|60000|",
            "[H][>]{[>]CC([>])(C[<])C(=O)OCC(O)CSc1c(F)c(F)c(F)c(F)c1F[<]}[<]CC.",
            "[H][>|0.0|]{[>]CC([>])(C[<])C(=O)OCC(O)CSc1c(F)c(F)c(F)c(F)c1F[<]}|schulz_zimm(500.0, 10.0)|[<]CC.|60000.0|",
            "A",
            "B",
            None,
        ),
    ...
    for text, big, ref, gen, mir_gen, graph_gen in test_args:
        ...
        print(schulz_zimm_distribution, ref)
