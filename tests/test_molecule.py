...
def test_molecule():
    test_args = [
        ...
        (
            ...
            "[H]CC(C)(CC(C)(CC(C)(CC(C)(CCCC(c1ccccc1)C(C)CC(c1ccccc1)c1ccccc1)C(=O)OCC(O)CSC(F)(F)F)C(=O)OCC(O)CSC(F)(F)F)C(=O)OCC(O)CSC(F)(F)F)C(=O)OCC(O)CSc1ccc(F)c(F)c1",
        ),
        (
            ...
            "[H]C(CC(C)(CC(C)(CC(C)(CC(C)(CC(C)(C[N])C(=O)OCC(O)CSc1ccc(F)c(F)c1)C(=O)OCC(O)CSC(F)(F)F)C(=O)OCC(O)CSc1ccc(F)c(F)c1)C(=O)OCC(O)CSC(F)(F)F)C(=O)OCC(O)CSc1ccc(F)c(F)c1)c1ccccc1",
        ),
    ]
