...
def test_stochastic():
    test_args = [
        ...
        ("{[][$]C([$])C=O,[$]CC[$]CO;[$][H], [$1]O[]}",
         "{[][$]C([$])C=O, [$]CC[$]CO; [$][H], [$1]O[]}",
         "{[][$]C([$])C=O, [$]CC[$]CO; [$][H], [$1]O[]}", ),
        ("{[][$|0 3 4 5 6 0 8 9|]C([$|4.|])C=O|0.5|,[$|6.|]CC[$|0.1|]CO;[$][H], [$1]O|.1|[]}|flory_schulz(1e-3)|.|10000|",
         "{[][$]C([$])C=O, [$]CC[$]CO; [$][H], [$1]O[]}",
         "{[][$|0.0 3.0 4.0 5.0 6.0 0.0 8.0 9.0|]C([$|4.0|])C=O|0.5|, [$|6.0|]CC[$|0.1|]CO|0.5|; [$][H]|0.9|, [$1]O|0.1|[]}|flory_schulz(0.001)|.|10000.0|", ),
    ...
    for text, big, ref in test_args:
        ...
        print(ref)
        print(stochastic.generate_string(True))
